  ...
  works: {
    ...
    items: [
      ...
      },
      {
        ...
        role: "開発",
        summary:
          "生成AIを利用した、鳥人間サークルの機体三面図を自動で3D化するシミュレーターを開発しました。生成AIが三面図からblenderで3Dモデルを自動生成し、その3Dデータをブラウザソフトで確認してより完成形をイメージできるようにしました。現在はAIの精度を向上させて忠実に再現できるように挑戦しています。将来的には飛行シミュレーションや風洞実験のための基盤を整えます。",
