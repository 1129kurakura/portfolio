const SITE_DATA = {
  ...
  works: {
    ...
    // ▼ 並び方（自動）
    //   ・year に "Now" か "現在" が入っている → 「現在」、それ以外 → 「過去」
    //   ・それぞれ year の先頭の年月で古い順に並ぶ
    //     （"2026.Sep" / "2026.09" / "2026-9" / "2026年9月" のどれでも読めます）
    //   ・同じ年月のものは、下の items に書いた順
    //   ・自動判定を変えたいときは、項目に status: "current"（現在）か "past"（過去）を書く
    //   ・年月が読めない year（"NEXT" など）は、そのグループの最後に並ぶ
    groups: {
